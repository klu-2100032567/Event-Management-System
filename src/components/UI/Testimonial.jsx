    ...
    <Slider {...settings}>
      <div className="testimonial py-4 px-3">
        ...
        <div className="mt-3 d-flex align-items-center gap-4">
          ...
          <div>
            <h6 className="mb-0 mt-3">Martin</h6>
      ...
      <div className="testimonial py-4 px-3">
        ...
        <div className="mt-3 d-flex align-items-center gap-4">
          ...
          <div>
            <h6 className="mb-0 mt-3">Suseela</h6>
            <p className="section__description">Customer</p>
          </div>
        </div>
      </div>
      ...
      <div className="testimonial py-4 px-3">
        ...
        <div className="mt-3 d-flex align-items-center gap-4">
          ...
          <div>
            <h6 className="mb-0 mt-3">Murali</h6>
            <p className="section__description">Customer</p>
          </div>
        </div>
      </div>
      ...
      <div className="testimonial py-4 px-3">
        ...
        <div className="mt-3 d-flex align-items-center gap-4">
          ...
          <div>
            <h6 className="mb-0 mt-3">Sweety</h6>
            <p className="section__description">Customer</p>
          </div>
        </div>
      </div>
